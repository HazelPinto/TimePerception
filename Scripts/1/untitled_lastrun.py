...
text_3 = visual.TextStim(win=win, name='text_3',
    text='The amount of seconds you have to estimate is ',
    font='Open Sans',
...
# keep track of which components have finished
InstructionsComponents = [text_instr, image_instr1, image_instr2, image_illus, image_next, mouse]
...
for thisTrial in trials:
    ...
    text_8.setText(Participant1)
    text_10.setText(Participant1)
    # keep track of which components have finished
    t_2Components = [key_resp_2, text_5, text_6, text_7, sound_1, text_12, text_13, text_8, text_9, text_10, text_11]
    ...
    while continueRoutine:
        ...
        # *text_6* updates
        if text_6.status == NOT_STARTED and tThisFlip >= 5.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *text_7* updates
        if text_7.status == NOT_STARTED and tThisFlip >= 12.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        if text_12.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_12.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if text_13.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_13.tStartRefresh + 4-frameTolerance:
                # keep track of stop time/frame for later
        ...
        if text_8.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > text_8.tStartRefresh + 4.0-frameTolerance:
                # keep track of stop time/frame for later
        ...
        # *text_10* updates
        if text_10.status == NOT_STARTED and tThisFlip >= 18.0-frameTolerance:
            # keep track of start time/frame for later
        ...
        # *text_11* updates
        if text_11.status == NOT_STARTED and tThisFlip >= 18.0-frameTolerance:
            # keep track of start time/frame for later
